...
perl "$SCRIPT_DIR/pl/gatkSNPcallsv2.pl" "$sample_name" "$SAMPLES_DIR" "$OUT_DIR" "$PICARD_DIR" "$GATK_DIR" "$JAVA_MAX_HEAP_SIZE" "$SAMTOOLS_PATH"

# 8. vcf2ambigfasta and vcf2haplofasta
...
perl "$SCRIPT_DIR/pl/vcf2fasta_qual.pl" "$sample_name" "$OUT_DIR"
