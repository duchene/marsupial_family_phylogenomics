...
# 10. gatherAmbigContigs and gatherHaploContigs
echo gatherAmbigContigs at $(date)
perl "$SCRIPT_DIR/pl/gatherAmbigContigs.pl" "$OUT_DIR" "$SAMPLES_LIST" "$TARGET_EXON_SEQS_LIST"

echo gatherHaploContigs at $(date)
perl "$SCRIPT_DIR/pl/gatherHaploContigs.pl" "$OUT_DIR" "$SAMPLES_LIST" "$TARGET_EXON_SEQS_LIST"
